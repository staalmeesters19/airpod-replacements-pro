...
const Hero = () => {
  ...
  return (
    <section 
      className="relative overflow-hidden min-h-[360px] md:min-h-[600px] flex items-center"
      style={{
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-10 relative z-10 py-6 md:py-0">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base md:text-xl text-white/80 mb-5 md:mb-10 max-w-2xl mx-auto leading-relaxed">
            {isEnglish 
          ...
          <div className="flex flex-row gap-2 md:gap-4 justify-center">
            <Button asChild size="default" className="text-sm md:text-base px-4 md:px-8 h-10 md:h-12 rounded-full bg-white text-foreground hover:bg-white/90">
              <Link to={`${prefix}${isEnglish ? '/single-airpods' : '/losse-airpods'}`}>
                {isEnglish ? 'Single AirPods' : 'Losse AirPods'}
              </Link>
            </Button>
            <Button asChild variant="outline" size="default" className="text-sm md:text-base px-4 md:px-8 h-10 md:h-12 rounded-full border-black/30 bg-black/80 text-white hover:bg-black/90 hover:text-white">
