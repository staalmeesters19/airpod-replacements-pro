...
const BlogAirpodsSchoonmaken = () => {
  ...
  const content = {
    nl: {
      ...
      airpodsProTip: "Zijn je oortips versleten of kwijt? Bij RePairPods verkopen we losse siliconen oortips voor alle maten.",
      ...
      soundProblemsCta: "In deze gevallen is het vaak voordeliger om een losse AirPod te vervangen dan een volledig nieuwe set te kopen. Bij RePairPods bieden we losse AirPods aan voor alle generaties - van AirPods 2 tot de nieuwste AirPods 4.",
      ...
      ctaText: "Bij RePairPods helpen we je met alles rondom je AirPods. Van losse oordopjes tot oplaadcases en siliconen tips - allemaal tegen scherpe prijzen en met snelle levering.",
    ...
    en: {
      ...
      airpodsProTip: "Are your ear tips worn or lost? At RePairPods we sell individual silicone ear tips in all sizes.",
      ...
      soundProblemsCta: "In these cases, it's often more affordable to replace an individual AirPod than to buy a completely new set. At RePairPods, we offer individual AirPods for all generations - from AirPods 2 to the latest AirPods 4.",
      ...
      ctaText: "At RePairPods, we help you with everything related to your AirPods. From individual earbuds to charging cases and silicone tips - all at competitive prices with fast delivery.",
