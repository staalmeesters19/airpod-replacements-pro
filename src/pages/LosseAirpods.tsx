...
const LosseAirpods = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Losse AirPods Kopen | Links & Rechts per Stuk | RePairPods</title>
        <meta
          name="description"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "CollectionPage",
            "name": "Losse AirPods Kopen",
            "description": "Koop losse AirPods per stuk - linker of rechter AirPod kwijt? Vervang alleen wat je mist.",
            "url": "https://repairpods.nl/losse-airpods",
            "mainEntity": {
              "@type": "ItemList",
              "numberOfItems": earbuds.length,
              "itemListElement": earbuds.slice(0, 10).map((product, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "item": {
                  "@type": "Product",
