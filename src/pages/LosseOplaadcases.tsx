  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Koop een losse AirPods oplaadcase. Case kwijt of kapot? Alle generaties op voorraad: AirPods 2, 3, 4, Pro 1 & Pro 2. 100% origineel Apple, morgen in huis."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "CollectionPage",
            "name": "Losse Oplaadcases Kopen",
            "description": "Koop een losse AirPods oplaadcase - case kwijt of kapot? Alle generaties op voorraad.",
            "url": "https://repairpods.nl/losse-oplaadcases",
            "mainEntity": {
              "@type": "ItemList",
              "numberOfItems": cases.length,
              "itemListElement": cases.slice(0, 10).map((product, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "item": {
                  "@type": "Product",
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-10 py-8">
            ...
            <section className="mt-16 prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                geen replica's. Elke case wordt zorgvuldig getest op batterijcapaciteit en 
            ...
            <section className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link 
                ...
                className="p-6 bg-secondary/30 rounded-xl hover:bg-secondary/50 transition-colors"
              >
                <h3 className="font-semibold mb-2">Accessoires</h3>
                <p className="text-sm text-muted-foreground">Tips, hoesjes en meer</p>
              </Link>
            </section>
          </div>
        </main>
