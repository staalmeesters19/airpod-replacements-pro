...
const ProductDetail = () => {
  ...
  // Related products (same model, different side/type)
  ...
  return (
    <>
      <Helmet>
        <title>{product.name} | PairPods</title>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-4">
                <div className="aspect-square bg-secondary/50 rounded-2xl flex items-center justify-center p-12 relative">
                  ...
                  />
                  {discount > 0 && (
                    <Badge className="absolute top-4 right-4 bg-destructive text-destructive-foreground text-base px-4 py-2">
                      -{discount}%
                    </Badge>
                  )}
                </div>
              ...
              <div className="space-y-6">
                ...
                <Button size="lg" className="w-full md:w-auto px-12" disabled={product.stock === 0}>
